      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-zinc-400">
            Manage your assigned orders and update progress
          </p>
        </div>
        ...
        {orders.length === 0 ? (
          <div className="glass-card rounded-2xl p-12 text-center">
            ...
            <p className="text-zinc-500 text-sm mt-2">
              New orders will appear here once admin assigns them to you.
            </p>
          </div>
        ) : (
            ...
            {orders.map((order) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  <Link
                    to={`/order/${order.id}`}
                    className="flex-1 bg-surface hover:bg-surface-hover text-white font-semibold py-2.5 rounded-lg transition-all text-center border border-border"
                  >
                    View Chat
                  </Link>
